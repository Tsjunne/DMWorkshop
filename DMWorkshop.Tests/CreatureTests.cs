...
namespace DMWorkshop.Tests
{
    public class CreatureTests
    {
        ...
        private Creature CreateGoblin()
        {
            ...
            var attacks = new[]
            {
                new Attack { Name="Scimitar", Type=AttackType.Melee|AttackType.Weapon, Finesse=true, Damage=new[]{ new Damage { DieCount=1, DieSize=6, DamageType=DamageType.Slashing} } },
                new Attack { Name="Shortbow", Type=AttackType.Ranged|AttackType.Weapon, Range=80, MaxRange=320, Damage=new[]{ new Damage { DieCount=1, DieSize=6, DamageType=DamageType.Piercing} } }
            };
