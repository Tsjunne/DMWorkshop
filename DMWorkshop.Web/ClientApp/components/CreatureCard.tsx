...
import { Card, Image, Icon, Label, Table } from "semantic-ui-react";
        ...
        return (
            <Card >
                <Card.Content>
                    ...
                    <Card.Meta>
                        <Table basic='very' collapsing compact size='small'>
                            <Table.Body>
                                <Table.Row>
                    ...
                    <Card.Description>
                        <Table basic='very' collapsing compact size='small'>
                            <Table.Body>
                                <Table.Row>
                                    <Table.Cell><Image avatar size='mini' src='/images/strength.svg' /></Table.Cell>
                                    <Table.Cell><Image avatar size='mini' src='/images/dexterity.svg' /></Table.Cell>
                                    <Table.Cell><Image avatar size='mini' src='/images/constitution.svg' /></Table.Cell>
                                    <Table.Cell><Image avatar size='mini' src='/images/intelligence.svg' /></Table.Cell>
                                    <Table.Cell><Image avatar size='mini' src='/images/wisdom.svg' /></Table.Cell>
                                    <Table.Cell><Image avatar size='mini' src='/images/charisma.svg' /></Table.Cell>
                                </Table.Row>
